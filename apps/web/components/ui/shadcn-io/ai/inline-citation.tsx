...
export const InlineCitationCardTrigger = ({
  ...
  return (
    <HoverCardTrigger asChild>
      <Badge
        className={cn(
          'ml-1 rounded-full !bg-slate-200 dark:!bg-slate-700 hover:!bg-slate-300 dark:hover:!bg-slate-600 text-slate-700 dark:text-slate-200 hover:text-slate-900 dark:hover:text-slate-100 transition-colors cursor-pointer',
          className
        )}
        {...props}
      >
...
export const InlineCitationCarouselHeader = ({
  ...
  <div
    className={cn(
      'flex items-center justify-between gap-2 rounded-t-md bg-secondary px-4 py-2 -mx-4 -mt-4 mb-4',
      className
    )}
    {...props}
  />
...
export const InlineCitationSource = ({
  ...
  <div className={cn('space-y-1 pb-2', className)} {...props}>
    {title && url && (
      <a 
        href={url} 
        className="truncate font-medium text-sm leading-tight text-primary hover:underline block"
        target="_blank"
